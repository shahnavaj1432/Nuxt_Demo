       ...
       <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          ...
          <div class="px-3 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-10" style="background-image: url('https://www.toptal.com/designers/subtlepatterns/uploads/dot-grid.png') ;">
             <div class="mx-auto max-w-screen-sm">
                ...
                <p class="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Overall, Polytechnic Notes provides a valuable resource for students pursuing technical and vocational education, helping them to improve their understanding, save time, and achieve better grades.</p>
             </div>
