import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, shallowReactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, computed, reactive, isReadonly, defineAsyncComponent, isRef, withCtx, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/create-e9bf7de4.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-9b6782dc.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-d326dc56.mjs').then((m) => m.default || m)
};
